# Anonymous Housing Quality Assessment
...
The contract is deployed on the Ethereum network and utilizes FHEVM (Fully Homomorphic Encryption Virtual Machine) for privacy-preserving computations.
